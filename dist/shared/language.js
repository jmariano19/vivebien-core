...
exports.extractNameFromAIResponse = extractNameFromAIResponse;
/**
 ...
 */
function extractUserName(userMessage, recentMessages) {
    ...
    const askedForName = lastAssistantMessage && nameRequestPatterns.some(pattern => pattern.test(lastAssistantMessage.content));
 ...
 */
function extractNameFromAIResponse(aiResponse) {
    const patterns = [
